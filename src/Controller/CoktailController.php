...
class CoktailController extends AbstractController
{
    ...
    #[Route('/fetch-fruits/{couleurId}', name: 'fetch_fruits', methods: ['GET'])]
    public function fetchFruits(FruitRepository $fruitRepo, $couleurId): JsonResponse
    {
        $fruits = $fruitRepo->findBy(['couleurs' => $couleurId]);
